<template>
  <div class="inventory-card w-full max-w-[1200px] bg-nature-800 border-[10px] border-nature-500 rounded-xl py-5 px-[50px]! flex flex-col gap-4 shadow-2xl text-white font-sans">
