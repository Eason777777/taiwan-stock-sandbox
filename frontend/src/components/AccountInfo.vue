<template>
  <div>
    <div class="flex justify-around items-center gap-2 sm:gap-6" data-tutorial="inventory-accounts">
      <!-- 1. 交割戶 -->
      <div class="flex flex-col justify-center min-w-0">
        <span class="text-white font-sans text-02 sm:text-03 md:text-04 text-left">
          交割戶
        </span>
        <span class="text-white font-sans text-04 sm:text-05 md:text-07 font-05 text-right truncate">
          {{ deliveryBalance }}
        </span>
      </div>
      ...
      <div class="flex flex-col justify-center shrink-0">
        ...
        >
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="90" height="90" viewBox="0 0 90 90" fill="none" class="w-[36px] h-[36px] sm:w-[56px] sm:h-[56px] md:w-[90px] md:h-[90px]">
      ...
      <!-- 3. 存款戶 -->
      <div class="flex flex-col justify-center min-w-0">
        <span class="account-name text-white font-sans text-02 sm:text-03 md:text-04 font-normal text-left">
          存款戶
        </span>
        <span class="account-amount text-white font-sans text-04 sm:text-05 md:text-07 font-05 text-right truncate">
          {{ savingsBalance }}
        </span>
      </div>
